...
Routine file autosaves retain dirty/restart protection without rendering an error or retry control during the debounce or write. The autosave owner marks failed or blocked saves as needing retry, and FileSaveStatus renders only those actionable states.
